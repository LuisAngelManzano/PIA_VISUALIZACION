...
# Form implementation generated from reading ui file 'c:\Users\angel\Desktop\PIA_VISUALIZACION\PaginaPawPatrol - copia.ui'
#
...
"")
        ...
        self.ImagenFenomenoSiniestroFondo.setPixmap(QtGui.QPixmap("c:\\Users\\angel\\Desktop\\PIA_VISUALIZACION\\imagenes/patrulla-canina-superpelicula-3056570.jpg.png"))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelTituloFenomenoSiniestro.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:48pt; font-weight:600; color:#ffffff;\">PAW PATROL: LA PELICULA</span></p><p><br/></p><p><br/></p></body></html>"))
        self.labelSinpsisFenomenOSiniestro.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#dadada;\">La Patrulla Canina se enfrenta a un gran desafío: evitar que el nuevo alcalde de la ciudad, </span></p><p><span style=\" color:#dadada;\">Humdinger, cause demasiados problemas. Equipados con la mejor tecnología,los cachorros luchan </span></p><p><span style=\" color:#dadada;\">juntos para salvar a los habitantes de Ciudad Aventura.<br/></span></p></body></html>"))
