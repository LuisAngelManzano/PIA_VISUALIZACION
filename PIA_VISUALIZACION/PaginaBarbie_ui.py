...
# Form implementation generated from reading ui file 'c:\Users\angel\Desktop\PIA_VISUALIZACION\PaginaBarbie.ui'
#
...
"")
        ...
        self.ImagenBarbieFondo = QtWidgets.QLabel(self.centralwidget)
        self.ImagenBarbieFondo.setGeometry(QtCore.QRect(0, 0, 1281, 711))
        font = QtGui.QFont()
        font.setUnderline(False)
        self.ImagenBarbieFondo.setFont(font)
        self.ImagenBarbieFondo.setStyleSheet("QLabel {\n"
"    opacity: 0.9;\n"
"}\n"
"")
        self.ImagenBarbieFondo.setText("")
        self.ImagenBarbieFondo.setPixmap(QtGui.QPixmap("c:\\Users\\angel\\Desktop\\PIA_VISUALIZACION\\ImagenesPeliculas Pag/primeras_criticas_de_barbie.jpg.png"))
        self.ImagenBarbieFondo.setScaledContents(True)
        self.ImagenBarbieFondo.setObjectName("ImagenBarbieFondo")
        self.labelTituloBarbie = QtWidgets.QLabel(self.centralwidget)
        self.labelTituloBarbie.setGeometry(QtCore.QRect(40, 90, 591, 61))
        self.labelTituloBarbie.setStyleSheet("QLabel {\n"
"    background-color: rgba(255, 255, 255, 0);\n"
"    color: rgba(0, 0, 0, 0); /* Cambia el color de texto a transparente */\n"
"}\n"
"\n"
"color: white;")
        self.labelTituloBarbie.setObjectName("labelTituloBarbie")
...
"color: white;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.labelTituloBarbie.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:48pt; font-weight:600; color:#ffffff;\">Barbie</span></p></body></html>"))
        self.labelSinpsisBlue.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-family:\'Helvetica Neue\'; color:#ffffff;\">Después de ser expulsada de Barbieland por no ser una muñeca de aspecto perfecto, </span></p><p><span style=\" font-family:\'Helvetica Neue\'; color:#ffffff;\">Barbie parte hacia el mundo humano para encontrar la verdadera felicidad.</span></p></body></html>"))
        self.labelDuracion.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:11pt; font-weight:600; color:#ffffff;\">1h 54m</span></p></body></html>"))
        self.labelGenero.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600; color:#ffffff;\">FANTASIA</span></p></body></html>"))
